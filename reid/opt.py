...
parser.add_argument('--data_path',
                    default="/home/yebotao/PycharmProjects/pedestrian_detection_and_re-id/reid/Market-1501-v15.09.15",
                    help='path of Market-1501-v15.09.15')

parser.add_argument('--mode',
                    default='compare', choices=['train', 'evaluate', 'vis', 'compare'],
...
parser.add_argument('--compare_img_a',
                    default='test_data/query1.jpg',
                    help='path to the image you want to compare')

parser.add_argument('--compare_img_b',
                    default='test_data/query2.jpg',
                    help='path to the image you want to compare')
